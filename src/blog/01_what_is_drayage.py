...
<section class="section faq">
  <div class="container">
    ...
    <div class="faq-list">
      ...
      <details class="faq-item"><summary>How is drayage priced?</summary><div class="faq-answer">Most <a href="/charleston-drayage/">Charleston drayage</a> carriers quote a per-container linehaul rate based on the ZIP code of the pickup and delivery, plus a fuel surcharge percentage. Accessorials are quoted separately and only apply when triggered: chassis day rate, chassis split fee, pre-pull and storage, <a href="/services/overweight-drayage/">overweight permits</a>, hazmat handling, driver detention, and demurrage pass-through.</div></details>
