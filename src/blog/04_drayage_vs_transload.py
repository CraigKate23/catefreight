...
<section class="section">
  <div class="container">
    <article class="prose">
      ...
      <p>For any move you give us, we'll quote the dray version straight up and tell you when transload likely beats it. We won't push you toward transload (or away from it) for our own reasons — we'd rather lose a long dray and earn a referral than hand you a quote you should have rejected.</p>
