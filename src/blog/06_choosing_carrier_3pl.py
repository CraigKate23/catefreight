...
<section class="section faq">
  <div class="container">
    ...
    <div class="faq-list">
      ...
      <details class="faq-item"><summary>Do Charleston drayage companies serve warehouses outside the metro?</summary><div class="faq-answer">Most cover Charleston, Berkeley, and Dorchester counties as the core zone — Charleston, North Charleston, Summerville, Goose Creek, Ladson, Moncks Corner — and many, including Cate Freight, run the <a href="/coverage/">I-26 corridor to Columbia and the Upstate</a> and I-95 lanes into Georgia and North Carolina. Confirm the delivery ZIP up front; per-mile pricing and chassis logistics change once a dray leaves the tri-county area.</div></details>
    </div>
  </div>
</section>
"""
