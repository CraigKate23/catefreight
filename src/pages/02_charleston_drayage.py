...
<section class="section">
  <div class="container narrow">
    ...
    <div class="prose">
      ...
      <h3>Drayage, container trucking, port trucking — same move, different names</h3>
      <p>If you searched for <strong>container trucking in Charleston, SC</strong> or a port trucking company rather than a "drayage carrier," you're in the right place — they're the same job. Warehouse managers tend to say container trucking, steamship lines say haulage, forwarders and 3PLs say drayage; either way it means a truck, a chassis, and an ocean container moving between an SCPA terminal and your dock. Whatever you call it, the move runs through the same gate process: release verified first, then <a href="/services/import-container-drayage/">import pickup</a> or <a href="/services/export-container-drayage/">export delivery</a>, then the empty back to the terminal. What matters isn't the label — it's whether the trucking company checks the release before the truck rolls.</p>
      <h3>Intermodal drayage and intermodal trucking in Charleston</h3>
      <p>The other name you'll see is <strong>intermodal drayage</strong>, or "intermodal trucking." Strictly, intermodal means the container rides more than one mode — ship, then truck, or ship, then rail, then truck. In Charleston that distinction is thinner than at other ports, because there is no on-dock rail: every box that leaves Wando Welch, North Charleston, or Hugh Leatherman leaves on a chassis behind a truck. An import routing to the Norfolk Southern or CSX railhead in North Charleston still needs a dray from the terminal to the ramp, and an inbound rail box headed to a Summerville or Goose Creek consignee needs the rail-to-door leg. Cate Freight runs both — see the port-to-rail section of our <a href="/services/transload-drayage/">transload and rail drayage</a> page — and when the Navy Base Intermodal Facility opens beside Hugh Leatherman, that ramp dray gets shorter, not eliminated. If you're deciding whether a Charleston container should move pure drayage, transload, or intermodal rail, <a href="/resources/drayage-vs-transload-intermodal/">this comparison</a> walks the trade-offs by lane and container count.</p>
    </div>
  </div>
</section>
"""
