...
<section class="page-hero">
  <div class="container">
    ...
    <p>Cate Freight is a Charleston drayage carrier first. Within that, we work imports and exports, reefer and dry, overweight and OOG, port-to-warehouse and pier returns, transload coordination and pre-pull staging. Pick the move you need to make.</p>
    <div class="actions">
      <a class="btn btn-primary" href="/quote/">Request a quote</a>
    </div>
  </div>
...
<section class="section">
  <div class="container">
    <div class="card-grid">
      <div class="card"><div class="icon" aria-hidden="true">⚓</div><h3>Port drayage</h3><p>Pickup and return at all three SCPA container terminals.</p><a class="card-link" href="/services/port-drayage/">Port drayage</a></div>
      <div class="card"><div class="icon" aria-hidden="true">⬇️</div><h3>Import container drayage</h3><p>Release-checked, customs-cleared imports from Charleston to your destination.</p><a class="card-link" href="/services/import-container-drayage/">Import drayage</a></div>
      <div class="card"><div class="icon" aria-hidden="true">⬆️</div><h3>Export container drayage</h3><p>Loaded export delivery to terminal with ERD-aware scheduling.</p><a class="card-link" href="/services/export-container-drayage/">Export drayage</a></div>
      <div class="card"><div class="icon" aria-hidden="true">🏬</div><h3>Port-to-warehouse</h3><p>Direct port-to-DC moves with appointments confirmed at both ends.</p><a class="card-link" href="/services/port-to-warehouse-drayage/">Port-to-warehouse</a></div>
      <div class="card"><div class="icon" aria-hidden="true">↔️</div><h3>Transload &amp; coordination</h3><p>Container delivery to a transload yard plus warehouse coordination.</p><a class="card-link" href="/services/transload-drayage/">Transload</a></div>
      <div class="card"><div class="icon" aria-hidden="true">🥶</div><h3>Reefer drayage</h3><p>Genset chassis, verified set points, pre-trip inspection on every move.</p><a class="card-link" href="/services/reefer-drayage/">Reefer</a></div>
      <div class="card"><div class="icon" aria-hidden="true">🏋️</div><h3>Overweight &amp; OOG</h3><p>Tri-axle chassis, route permits, 60,000+ lb experience.</p><a class="card-link" href="/services/overweight-drayage/">Overweight</a></div>
      <div class="card"><div class="icon" aria-hidden="true">⏳</div><h3>Pre-pull service</h3><p>Stage containers off-port to stop the demurrage clock when free time is tight.</p><a class="card-link" href="/services/import-container-drayage/#pre-pull">Pre-pull info</a></div>
    </div>
  </div>
</section>
"""
