...
<section class="section bg-surface">
  <div class="container">
    ...
    <div class="card-grid">
      <div class="card"><h3>The drayage quote checklist</h3><p>The exact information a <a href="/charleston-drayage/">Charleston drayage</a> carrier needs from you to come back with a usable number on the first try.</p><a class="card-link" href="/resources/drayage-quote-checklist/">Read the checklist</a></div>
